<?php
    if(isset($_POST['csimpan'])){
        ...
        $tkeluar = mysqli_query($conn,"INSERT INTO tbl_keluar (id_barang,penerima,stok) VALUES ('$barangnya','$penerima','$stock')");
        $updatestockkeluar = mysqli_query($conn,"UPDATE tbl_stok SET stok='$tambahstockdenganqty' WHERE id_barang='$barangnya'");
        if($tkeluar&&$updatestockkeluar){
            echo"<script>
        ...
        <div class="card shadow bg-gradient-light">
            ...
            <div class="p-5">
                    ...
                    <form class="user" method="POST" action="">
                        ...
                        <button class="btn btn-primary btn-user btn-block" name="csimpan" type="submit">
                            Submit
                        </button>
                    </form>
                </div>
